...
\begin{itemize}
   \item \emph/Profesor/ vsebuje osebne podatke profesorja (ime in priimek) ter
...
\noindent Algoritem je najbolje implementirati tako, da do kršenja strogih omejitev sploh ne more priti.
...
\noindent Pri ročnem sestavljanju urnika se ponavadi sestavi zadostni urnik, ki zadošča le
...
\noindent \emph/Sistem okolic/ je množica vseh možnih sprememb, ki jih lahko z vsemi operacijami iz
