...
\usepackage{color}
\usepackage{xcolor}
\usepackage[backend=biber]{biblatex} % Povemo, da uporabljamo biber
\addbibresource{magic.bib}
\usepackage{csquotes}
...
\begin{table}[!ht]
   \centering
   \caption{Magicni kvadrat reda 3}
   \label{table:mag3}
   \large
...
primer Euler, glej \ref{fig:sagrada}. % ključ: euler
...
\begin{figure}[h]
\centering
\includegraphics[scale=1.50]{durer.png}
...
\begin{figure}[h]
   \centering
   \caption{Fotografija pasijonske fasade na katedrali Sagrada Família}
   \includegraphics[width=0.6\textwidth]{sagrada.png} % prilagodi velikost po želji
...
\label{bessy} \label{berlekamp} \label{gardner} \label{pinn}
